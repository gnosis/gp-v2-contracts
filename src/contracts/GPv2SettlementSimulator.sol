...
contract GPv2Settlement {
    ...
    function settle(
        ...
        GPv2TradeExecutionWithErrorMsg.Data[] memory executedTrades =
            computeTradeExecutions(tokens, clearingPrices, encodedTrades);
        allowanceManager.transferIn2(executedTrades);
    ...
    function computeTradeExecutions(
        ...
        internal
        returns (GPv2TradeExecutionWithErrorMsg.Data[] memory executedTrades)
    {
        uint256 tradeCount = encodedTrades.tradeCount();
        executedTrades = new GPv2TradeExecutionWithErrorMsg.Data[](tradeCount);
    ...
    function computeTradeExecution(
        ...
        uint256 sellPrice,
        uint256 buyPrice,
        GPv2TradeExecutionWithErrorMsg.Data memory executedTrade
    ) internal {
    ...
    /// transferred out.
    function transferOut(GPv2TradeExecutionWithErrorMsg.Data[] memory trades)
        internal
    {
