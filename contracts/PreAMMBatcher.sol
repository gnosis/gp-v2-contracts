...
contract PreAMMBatcher {
    ...
    * assumes all ordres are fully covered
    ...
    {   
        ...
        Fraction memory lowerPriceBound = Fraction(buyOrders[0].buyAmount, buyOrders[0].sellAmount);
        Fraction memory higherPriceBound = Fraction(sellOrders[0].sellAmount, sellOrders[0].buyAmount);
