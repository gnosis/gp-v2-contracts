...
export const oneOrderSellingToken0IsObmittedTestInput = function (token0: Contract, token1: Contract,
  tradersToken0: Wallet[], tradersToken1: Wallet[]):
  TestCaseInput {
  return {
    fundingAMMToken0: utils.parseEther('10'),
    fundingAMMToken1: utils.parseEther('10'),
...
export const noSolutionTestInput = function (token0: Contract, token1: Contract,
  tradersToken0: Wallet[], tradersToken1: Wallet[]):
  TestCaseInput {
  return {
    fundingAMMToken0: utils.parseEther('10'),
...
export const oneOrderSellingToken1IsObmittedTestInput = function (token0: Contract, token1: Contract,
  tradersToken0: Wallet[], tradersToken1: Wallet[]):
  TestCaseInput {
  return {
    fundingAMMToken0: utils.parseEther('10'),
...
export const switchTokenTestInput = function (token0: Contract, token1: Contract,
  tradersToken0: Wallet[], tradersToken1: Wallet[]):
  TestCaseInput {
  return {
    fundingAMMToken0: utils.parseEther('10'),
